...
<body>
	<section>
		<h1>Manage Award Ceremony Booking's</h1>
		<table>
			<tr>
				<th>Day</th>
				<th>Date</th>
			...
			<tr>
				...
				<td>
				<input type="submit" onClick="location.href='acceptAwardMail.php'" value="Accept">
				<input type="submit" onClick="location.href='cancelAwardMail.php'" value="Cancel">
				</td>
			</tr>
			<?php
				}
