...
<body>
	<section>
		<h1>Manage Holi Event Booking's</h1>
		<table>
			<tr>
				<th>Day</th>
				<th>Date</th>
			...
			<tr>
				...
				<td><input type="submit" onClick="location.href='acceptHoliMail.php'" value="Accept">
				<input type="submit" onClick="location.href='cancelHoliMail.php'" value="Cancel"></td>
			</tr>
			<?php
				}
			?>
