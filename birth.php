...
include "navbar.php";
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") 
	{
		...
		$sql = "INSERT INTO `bday`(`Day`,`Date`, `Hour`, `Payment`, `Theme`, `Name`, `Phone`, `Person`,`email`,`latitude`,`longitude`) VALUES ('$day','$date', '$hour','$payment', '$theme','$name', '$phone','$person','$email','$latitude','$longitude')";

		if (mysqli_query($conn, $sql)) 
		{
            echo '<script>alert("Birthday Party Booking successful!");</script>';
		} 
		else 
		{
...
.banner{
    min-height: 100vh;
    background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("assets/20.jpg") center/cover no-repeat;
    display: flex;
...
.card-img{
    background: url("assets/9.jpeg") center/cover no-repeat;
}
.banner h2{
    padding-bottom: 40px;
    margin-bottom: 20px;
