...
<body>
	<section>
		<h1>Manage Birthday Party Booking's</h1>
		<table>
			<tr>
				<th>Day</th>
				<th>Date</th>
			...
			<tr>
				...
				<td>
					<input type="submit" onClick="location.href='acceptBdayMail.php'" value="Accept">
					<input type="submit" onClick="location.href='cancelBdayMail.php'" value="Cancel">
				</td>
			</tr>
			<?php
				}
