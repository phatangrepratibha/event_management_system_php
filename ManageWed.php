...
<body>
	<section>
		<h1>Manage Wedding Anniversary Booking's</h1>
		<table>
			<tr>
				<th>Day</th>
				<th>Date</th>
			...
			<tr>
				...
				<td><input type="submit" onClick="location.href='acceptWedMail.php'" value="Accept">
				<input type="submit" onClick="location.href='cancelWedMail.php'" value="Cancel"></td>
			</tr>
			<?php
				}
			?>
